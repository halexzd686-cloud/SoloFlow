...
在 `v1.0.0` 发布前，安全修复优先应用于最新 Release Candidate 和 `main`。旧的开发标签不保证持续维护。
...
- 潜在影响；
- 已知缓解方法；
- 是否涉及 Skill 安装、Registry、MCP 鉴权、路径处理或凭据泄露。
...
- 从第三方 Registry 安装 Skill 前应审查其内容；当前版本尚未提供签名和 checksum 验证。
